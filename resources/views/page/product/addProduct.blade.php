            ...
            <div class="mt-5 mb-5 mx-auto border border-dark rounded px-4">
                <form action="/addProductLogic" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_location')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_type')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_brand')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_category')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="vehicle_seat_capacity" name="vehicle_seat_capacity" value="{{ old('vehicle_seat_capacity') }}"/>
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_seat_capacity')}}</div>
                    </div>

                    <div class="mb-3">
                        <label for="vehicle_engine_capacity" class="form-label">Vehicle Engine Capacity(CC)</label>
                        <input type="number" class="form-control" id="vehicle_engine_capacity" name="vehicle_engine_capacity" value="{{ old('vehicle_engine_capacity') }}"/>
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_engine_capacity')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_fuel_type')}}</div>
                    </div>

                    <div class="mb-3">
                        <label for="vehicle_fuel_tank_capacity" class="form-label">Vehicle Full Tank Capacity(L)</label>
                        <input type="number" class="form-control" id="vehicle_fuel_tank_capacity" name="vehicle_fuel_tank_capacity" value="{{ old('vehicle_fuel_tank_capacity') }}"/>
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_fuel_tank_capacity')}}</div>
                    </div>

                    <div class="mb-3">
                        <label for="vehicle_fuel_consumption" class="form-label">Vehicle Full Consumption(KM/L)</label>
                        <input type="number" class="form-control" id="vehicle_fuel_consumption" name="vehicle_fuel_consumption" value="{{ old('vehicle_fuel_consumption') }}"/>
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_fuel_consumption')}}</div>
                    </div>

                    <div class="mb-3">
                        <label for="vehicle_milage" class="form-label">Vehicle Milage(KM)</label>
                        <input type="number" class="form-control" id="vehicle_milage" name="vehicle_milage" value="{{ old('vehicle_milage') }}"/>
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_milage')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        value="{{ old('vehicle_year_production') }}"/>
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_year_production')}}</div>
                    </div>

                    <div class="mb-3">
                        <label for="vehicle_tax" class="form-label">Vehicle Tax(RP)</label>
                        <input type="number" class="form-control" id="vehicle_tax" name="vehicle_tax" value="{{ old('vehicle_tax') }}"/>
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_tax')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_service_fee')}}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="files" class="form-label">Thumbnail Image (Image ratio 1:1)</label>
                        <input type="file" name="vehicle_cover_image" class="form-control" accept="image/*" >
                        <div id="emailHelp" class="mt-2 form-text alert-danger">{{$errors->first('vehicle_cover_image')}}</div>
                    </div>
